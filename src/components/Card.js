      ...
      <a className="card__link" href="/" target="_blanc" rel="noopener noreferrer nofollow">
        ...
        <div className="card__meta">
          <div className="card__stats">
            ...
            <span className="card__stars">5.0</span>
            <span className="card__reviews">(6)</span>
            <span className="card__country">USA</span>
          </div>
          <h2 className="card__title truncate">Life lessons with Katie Zaferes</h2>
          <span className="card__price-text"><span className="card__price">From $136</span> / person</span>
        </div>
      </a>
    </section>
  )
